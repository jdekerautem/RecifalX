      ...
      /* Trouver le type de la requête: maintenance, boutons relais, température */
        switch (jsonObject.action){
            case TYPE_MAINTENANCE:
                ...
                maintenanceAFaire(jsonObject.id, jsonObject.name);
